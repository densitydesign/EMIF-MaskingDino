...
class EfficientViTSamPredictor:
    ...
    def predict_torch(
        ...
        boxes: torch.Tensor or None = None, # type: ignore
    ...
    @torch.inference_mode() #added this to provide the boxes
    def apply_boxes_torch(self, boxes: torch.Tensor, original_size: Tuple[int, ...]) -> torch.Tensor:
        ...
        boxes[..., 2] = boxes[..., 2] * (new_w / old_w)
        boxes[..., 3] = boxes[..., 3] * (new_h / old_h)
        return boxes
...
def build_efficientvit_sam(image_encoder: EfficientViTSamImageEncoder, image_size: int) -> EfficientViTSam:
    return EfficientViTSam(
        ...
        prompt_encoder=PromptEncoder(
            ...
            input_image_size=(real_image_size, real_image_size),
            mask_in_chans=16,
        ),
        mask_decoder=MaskDecoder(
        ...
        image_size=(real_image_size, image_size),
    )
